+function ($) {
  'use strict';
    ...
    /* Note: Est appelÃ© par la fonction dÃ©finie en var */
    SelectSplitter.prototype.init = function (type, element, options) {
        ...
        // Note2: find(option:selected) retourne toujours une OPTION mÃªme lors du premier affichage.
    ...
    SelectSplitter.prototype.updateParentCategory = function () {
        ...
        // DÃ©finit la liste de I pour les icÃ´nes Ã  afficher en fonction de la page.
        var optionsHtml = '';
